...
import { t, X } from 'chart.js/dist/chunks/helpers.core';
import { ActivatedRoute, Router } from '@angular/router';
import { NgToastService } from 'ng-angular-popup';
Chart.register(...registerables)

@Component({
  selector: 'app-csvdataview',
  templateUrl: './csvdataview.component.html',
  styleUrls: ['./csvdataview.component.css']
})
export class CsvdataviewComponent implements OnInit {
chartdata:any;
currentdate:any;
id:any;
device:any;
